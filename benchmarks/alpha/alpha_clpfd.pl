...
:- module(alpha_clpfd, [main/0, alpha/2, alpha_ix/2]).
...
alpha(Lab, Consistency) :-
	...
	format('execution of alpha_clpfd took ~3d seconds\n', [P1-P0]),

	statistics(runtime, [T0,_]),
	labeling(Lab,LD),
	statistics(runtime, [T1,_]),
	format('alpha_clpfd labeling took ~3d seconds\n', [ T1-T0]),
...
alpha_ix(Lab, Consistency):-
	...
	statistics(runtime, [P1,_]),
	format('execution of alpha_clpfd_indexical took ~3d seconds\n', [P1-P0]),

	statistics(runtime, [T0,_]),
	labeling(Lab,LD),
	statistics(runtime, [T1,_]),
	format('alpha_clpfd_indexical labeling took ~3d seconds\n', [T1-T0]),
